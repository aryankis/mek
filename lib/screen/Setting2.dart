...
// int min;
//
// class _SettingState extends State<Setting2> with WidgetsBindingObserver {
//
//
//
//   var studi;
...
//     var scheduleDate = DateTime(now.year, now.month, now.day, now.hour,now.minute);
//
//     scheduleNotification(scheduleDate);
//
//     //listScheduledNotifications();
//     //scheduleNotification1();
//   }
//
//   Future listScheduledNotifications() async{
//     var list = await AwesomeNotifications().listScheduledNotifications();
//
//     for (NotificationModel item in list) {
//       String body = item.content?.body ?? '';
//       print(body);
//     }
//   }
//
...
//       scheduleDate = scheduledDate.add(Duration(minutes: 10));
//     }
//
//     addNotification(1, scheduleDate);
//
//     for (int i = 1; i<23; i++) {
//       var scheduleTime = scheduleDate.add(Duration(minutes: i*1));
//       addNotification(createUniqueId(), scheduleTime);
//     }
//   }
//
//   Future addNotification(int id, DateTime scheduleTime) async {
//
//     // var scheduleTime = DateTime.now().add(Duration(minutes: 1));
//
...
//             title: 'Just in time!',
//             body: 'This notification $id was schedule to shows at ' + scheduleTime.toString() ,
//             // wakeUpScreen: true,
...
//     //       channelKey: 'scheduled',
//     //       title: 'Just in time!',
//     //       body: 'This notification was schedule to shows at ' + scheduleTime.toString(),
//     //       category: NotificationCategory.Alarm,
//     //       wakeUpScreen: true,
//     //     ),
//     //     schedule: NotificationCalendar.fromDate(date: scheduleTime, repeats: true, preciseAlarm: true));
//
//
//   }
//   @override
...
//         );
//       }
//       Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (_)=> Setting2()), (route) => false);
...
//       context,
//       new MaterialPageRoute(builder: (context) => new Setting2()),
//     );
//   }
//
//
