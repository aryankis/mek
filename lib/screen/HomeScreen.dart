...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget    createCalanderInfo(PainScore event) {
    ...
    padtwo = event.question1a == 'null' ? 0 : int.tryParse(event.question1b);
    padthree = event.question1a == 'null' ? 0 : int.tryParse(event.question1c);

    tampons1 = event.question1a == 'null' ? 0 : int.tryParse(event.question2a);
    tampons2 = event.question1a == 'null' ? 0 : int.tryParse(event.question2b);
    tampons3 = event.question1a == 'null' ? 0 : int.tryParse(event.question2c);
