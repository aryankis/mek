...
Future<bool> finaldata() async {
  ...
  var question1a =
      pad1.getItem('pad1') != null ? pad1.getItem('pad1').toString() : '0';
  print("pad1 $question1a");
  var question1b =
      pad2.getItem('pad2') != null ? pad2.getItem('pad2').toString() : '0';
  print("pad2 $question1a");
  var question1c =
      pad3.getItem('pad3') != null ? pad3.getItem('pad3').toString() : '0';
  print("pad3 $question1c");
  var question2a =
      tam1.getItem('tam1') != null ? tam1.getItem('tam1').toString() : '0';
  print("tam1 $question2a");
  var question2b =
      tam2.getItem('tam2') != null ? tam2.getItem('tam2').toString() : '0';
  print("tam2 $question2b");
  var question2c =
      tam3.getItem('tam3') != null ? tam3.getItem('tam3').toString() : '0';
