    ...
    return Container(
      ...
      child: SafeArea(
        child: Scaffold(
              ...
              children: [
                ...
                Column(
                  children: <Widget>[
                    ...
                    //   child: Center(
                    //       child: Text(
                    //     ('Do you experience any pain relating to your period today'.tr()),
                    ...
                    //       return Row(
                    //         children: <Widget>[
                    //           // Radio(value: f.id, groupValue:f.name, onChanged: null),
                    //           RaisedButton(
                    //               autofocus: true,
                    ...
                    //               onPressed: () {
                    //                 setState(() {
                    //                   for (var i = 0; i < painScore.length; i++) {
                    //                     painScore[i].changeButtonColor = true;
                    //                   }
                    //                   if (f.changeButtonColor == false) {
          ...
          //       color: globals.primaryColor,
          //       onPressed: () {
          //         Navigator.pushReplacementNamed(context, '/addvalue');
          //       },
          //     ),
          //   ),
          // ],
